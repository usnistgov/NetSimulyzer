...
main (int argc, char *argv[])
{
  ...
  CommandLine cmd;
  cmd.AddValue ("x", "X component of the movement vector", movVecX);
  cmd.AddValue ("y", "Y component of the movement vector", movVecY);
  cmd.AddValue ("z", "Z component of the movement vector", movVecZ);
  cmd.Parse (argc, argv);
  ...
  ueNodes.Get (1)->GetObject<ConstantVelocityMobilityModel> ()->SetVelocity (Vector (movVecX, movVecY, movVecZ));
