 ...
 *
 * @return
 * The path to the selected directory. Empty string if nothing was selected
 */
QString getExistingDirectory(const QString &caption, QWidget *parent = nullptr);

/**
 * Wrapper for the file dialog which selects scenario file. Used to distinguish which platforms should
