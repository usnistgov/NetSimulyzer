...
PauseHandler::PauseHandler(char PauseKey) : pauseKey(PauseKey) {
}

bool PauseHandler::handle(osgGA::Event *event, osg::Object *, osg::NodeVisitor *) {

  // We need this as a GUI event to retrieve the Key
